...
#define RSB_HEADER_VERSION_STRING		"librsb version 1.3.0.2 - 202212201855"	/*!< \brief Library header version string. */
...
#define RSB_LIBRSB_VER_DATE		202212201855	/*!< \brief Version release date. */
...
#define RSB_DEFAULT_TYPE float	/*!< \brief The default numerical matrix type (can be used for declarations), used in the example programs. */
#define RSB_DEFAULT_POSSIBLY_INTEGER_TYPE float/*!< \brief The default, integer if possible , numerical type (can be used for declarations). */
...
#define RSB_DEFAULT_TYPE_STRING "float"	/*!< \brief A string specifying the name of the default type. */
#define RSB_DEFAULT_POSSIBLY_INTEGER_TYPE_STRING "float" /*!< \brief A string specifying the name of the default possibly integer type.*/
 ...
 */
#define RSB_MATRIX_TYPES_LIST_CXX		float,double /*!< \brief list of C++ types configured in this \librsb build, usable in \c <rsb.hpp> (since RSB_LIBRSB_VER>=10300) */
...
#define  RSB_NUMERICAL_TYPE_DEFAULT   RSB_NUMERICAL_TYPE_FLOAT   /*!< \brief A default numerical matrix type. */
#define  RSB_NUMERICAL_TYPE_DEFAULT_INTEGER   RSB_NUMERICAL_TYPE_FLOAT   /*!< \brief A default numerical matrix type; if possible, an integer one. */
...
*/
#define  RSB_NUMERICAL_TYPE_PREPROCESSOR_SYMBOLS "S D "
#define  RSB_BLAS_NUMERICAL_TYPE_PREPROCESSOR_SYMBOLS "S D "
...
( ((CODE)==RSB_NUMERICAL_TYPE_FLOAT )?(0):			\
( ((CODE)==RSB_NUMERICAL_TYPE_DOUBLE )?(1):			\
-1 ) \
) \
/* uhm. seems redundant ? */
...
#define RSB_IMPLEMENTED_TYPES		2
...
#define RSB_MATRIX_TYPES_ARRAY	{ "float","double", }
#define RSB_MATRIX_TYPE_CODES_ARRAY	{ RSB_NUMERICAL_TYPE_FLOAT ,RSB_NUMERICAL_TYPE_DOUBLE , }
#define RSB_MATRIX_SPBLAS_TYPE_CODES_ARRAY	{ RSB_NUMERICAL_TYPE_FLOAT ,RSB_NUMERICAL_TYPE_DOUBLE , }
...
#define RSB_M4_MATRIX_TYPES_STRING		"float, double"
